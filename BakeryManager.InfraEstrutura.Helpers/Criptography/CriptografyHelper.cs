...
namespace AddTech.Infraestrutura.Helpers.Criptography
{
    /// <summary>
    ...
    public class CriptografyHelper
    {

        #region Private members

        private string _key = "ExpertSecurity";
        ...
        public CriptografyHelper(CryptProvider cryptProvider)
        {
